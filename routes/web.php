...
Route::group(['middleware' => 'auth'], function(){
	...
	Route::resource('to_do_tasks', 'TaskboardController');
	Route::resource('task', 'TaskController');

	// Route::resource('to_do_tasks', 'TaskboardController');
	Route::post('tasks/update-status', [TaskboardController::class, 'updateStatus'])->name('tasks.update-status');
	...
	// Route::resource('task',TaskController::class)->names('task.index');
